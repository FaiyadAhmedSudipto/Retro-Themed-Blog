...
client.connect(err => {
    console.log(err)
    const blogsMoreCollection = client.db("blogSite").collection("bookings");
    // const eventCollection = client.db("volunteer").collection("events");
    const blogsCollection = client.db("blogSite").collection("services");
    const reviewsCollection = client.db("blogSite").collection("reviews");
    const adminCollection = client.db("blogSite").collection("admins");
        ...
        adminCollection.find({ email: req.query.email })
            ...
            .toArray((err, doc) => {
                ...
                if (doc.length !== 0) {
                    ...
                    res.json({ isAdmin: false, message : "Permission Not Denied"}).status(403);
                }
            })
    })
    ...
    app.post('/addBooking', (req, res) => {
        ...
        blogsMoreCollection.insertOne(newBooking)
            .then(result => {
    ...
    app.post('/addProduct', (req, res) => {
        ...
        blogsCollection.insertOne(newEvent)
            .then(result => {
    ...
    app.post('/addReviews', (req, res) => {
        ...
        app.get('/bookings', (req, res) => {
            blogsMoreCollection.find({ email: req.query.email })
